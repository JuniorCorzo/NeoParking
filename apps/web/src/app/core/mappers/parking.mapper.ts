...
export const mapToParkingLotsModel = (
  ...
  gracePeriodPrice: response.gracePeriodPrice,
  id: response.id,
  ivaRate: response.ivaRate,
  name: response.name,
...
export const mapListItemToUpsertParkingLotsModel = (
  ...
  gracePeriodMinutes: model.gracePeriodMinutes ?? 0,
  gracePeriodPrice: model.gracePeriodPrice ?? 0,
  id: model.id,
  ivaRate: model.ivaRate ?? 0.19,
  name: model.name,
  operatingHours: {
...
export const mapToUpsertParkingLotsRequest = (
  ...
  gracePeriodPrice: model.gracePeriodPrice,
  id: model.id,
  ivaRate: model.ivaRate,
  name: model.name,
