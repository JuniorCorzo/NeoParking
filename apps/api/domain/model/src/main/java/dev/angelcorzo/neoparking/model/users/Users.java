 ...
 *
 * <p>This class is an aggregate root that holds all information related to a user,
 * including their personal data, credentials, role, and association with a Tenant.</p>
 *
 * <p><strong>Layer:</strong> Domain</p>
 * <p><strong>Responsibility:</strong> To manage the state and business rules of a user.</p>
 *
 * @author Angel Corzo
 * @since 1.0.0
 * @see Tenants
