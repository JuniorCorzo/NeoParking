 ...
 * <p>
 * This utility class provides a centralized way to construct the claims maps for
 * different types of tokens, such as access tokens and refresh tokens. It ensures
 * consistency in the claims that are included in each token and abstracts the
 * creation logic away from the use cases that generate tokens.
 * </p>
 * <p>
 * The class is non-instantiable and all its methods are static.
 * </p>
 *
 * @author Angel Corzo
 * @version 1.0
...
public class JwtClaimsFactory {
     ...
     * <p>
     * Access tokens are intended for accessing protected resources and contain
     * detailed user information such as full name and role.
     * </p>
     *
     ...
     * <p>
     * Refresh tokens are used to obtain new access tokens and contain a minimal
     * set of claims to identify the user and the token's purpose.
     * </p>
     *
     * @param user the user for whom the token is being created.
     ...
     * <p>
     * This includes essential information such as the token ID (jti), subject (user ID),
     * tenant ID, and email.
     * </p>
     *
     * @param user the user for whom the token is being created.
