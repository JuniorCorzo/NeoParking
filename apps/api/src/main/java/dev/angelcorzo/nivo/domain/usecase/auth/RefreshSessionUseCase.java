...
import dev.angelcorzo.nivo.domain.model.users.exceptions.UserNotExistsInTenantException;
import dev.angelcorzo.nivo.domain.model.users.gateways.UsersRepository;
import dev.angelcorzo.nivo.domain.usecase.auth.helpers.JwtClaimsFactory;
...
public class RefreshSessionUseCase {
     ...
     * @throws dev.angelcorzo.nivo.domain.model.authentication.exceptions.SecurityException if the refresh token is invalid or expired.
     */
