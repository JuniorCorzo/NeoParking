  ...
  void getCurrentUser_shouldReturn200() throws Exception {
    ...
    Users currentUser =
        Users.builder()
            ...
            .role(Roles.MANAGER)
            .tenant(
                dev.angelcorzo.nivo.domain.model.tenants.valueobject.TenantReference.builder()
                    .id(tenantId)
    ...
    when(userMapper.toDTO(any(Users.class)))
        .thenReturn(
            dev.angelcorzo.nivo.infrastructure.entrypoint.rest.users.dto.UserDTO.builder()
                .id(userId)
                .fullName("Test User")
                .email("test@example.com")
                .role(Roles.MANAGER)
                .tenant(
                    dev.angelcorzo.nivo.infrastructure.entrypoint.rest.tenants.dto.TenantInfo.builder()
                        .id(tenantId)
                        .companyName("Test Corp")
                        .build())
                .contactInfo("+5491112345678")
